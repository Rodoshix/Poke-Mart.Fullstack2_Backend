...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Respuesta detallada de blog para administracion")
public class AdminBlogResponse {
    ...
    @Schema(description = "Estado actual", example = "DRAFT")
    ...
    @Schema(description = "Fecha de creacion", example = "2025-11-20T15:00:00")
    private LocalDateTime creadoEn;

    @Schema(description = "Ultima fecha de actualizacion", example = "2025-11-26T10:10:00")
